...
export const bydVehicles: BYDVehicle[] = [
  {
    ...
    features: ['Дальность 505 км', 'Быстрая зарядка', 'Панорамная крыша', 'Интеллектуальная система помощи'],
    brandColor: '#E60012',
    variants: [
      {
        id: 'sp1',
  ...
  },
  {
    ...
    features: ['Дальность 605 км', 'Роскошный интерьер', 'Система автопилота', 'Премиум звук Dynaudio'],
    brandColor: '#000000',
    variants: [
      {
        id: 'han1',
  ...
  },
  {
    ...
    features: ['Дальность 565 км', '7 мест', 'Полный привод', 'Адаптивная подвеска'],
    brandColor: '#E60012',
    variants: [
      {
        id: 'tang1',
  ...
  },
  {
    ...
    features: ['Дальность 480 км', 'Просторный салон', 'Современный дизайн', 'Доступная цена'],
    brandColor: '#000000',
    variants: [
      {
        id: 'atto1',
  ...
  },
  {
    ...
    features: ['Дальность 570 км', 'Динамичный дизайн', '0-100 км/ч за 3.8с', 'CTB технология'],
    brandColor: '#E60012',
    variants: [
      {
        id: 'seal1',
