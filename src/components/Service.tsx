...
export function Service() {
  ...
  const avgRating = serviceRequests
    .filter(r => r.rating)
    .reduce((sum, r) => sum + (r.rating || 0), 0) / serviceRequests.filter(r => r.rating).length;

  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-gray-900 mb-1">Сервисное обслуживание</h2>
        <p className="text-gray-500 text-sm">Управление сервисными запросами</p>
      </div>
      ...
      <div className="relative h-40 rounded-xl overflow-hidden">
        ...
        <div className="absolute inset-0 bg-gradient-to-r from-black/80 to-transparent flex items-center px-6">
          <div>
            ...
            <p className="text-gray-200 text-sm">Качественное обслуживание вашего автомобиля</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div className="p-5 border-b border-gray-200">
          <h3 className="text-gray-900">Сервисные запросы</h3>
        </div>
                ...
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <div>
                        <h4 className="text-gray-900">{request.customerName}</h4>
                    ...
                    <div className="flex flex-wrap gap-3 ml-13">
                      ...
                      <span className="text-sm text-gray-500">• Техник: {request.technician}</span>
                    </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className={`px-3 py-1 rounded-lg text-sm border ${statusColors[request.status]}`}>
      ...
      {/* Service Schedule */}
      <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
        <h3 className="text-gray-900 mb-4">Расписание на неделю</h3>
            ...
            return (
              <div key={day}>
                <div className="flex items-center justify-between mb-2">
                  ...
                  <span className="text-sm text-gray-900">{count} записей</span>
                </div>
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-white/90 mb-3">
              Автоматическая рассылка запросов на отзыв отправлена 2 клиентам после завершения обслуживания. 
              1 отзыв уже получен на Google Reviews.
            </p>
