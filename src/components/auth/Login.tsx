      ...
      <div className="max-w-sm w-full">
        ...
        <form onSubmit={handleSubmit} className="bg-white p-6 rounded-xl shadow-sm border border-gray-100">
          ...
          <button
            type="submit"
            disabled={isLoading}
            className="w-full bg-[#E60012] text-white py-2.5 px-4 rounded-lg font-medium hover:bg-[#c4000f] focus:ring-2 focus:ring-[#E60012] focus:ring-offset-1 transition-colors mt-6 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
            {isLoading ? (
              <>
