...
export function Reviews() {
  ...
  const reviews = [
    {
      ...
      rating: 5,
      comment: 'Отличный сервис! Очень доволен покупкой BYD Tang. Менеджер Малика была очень профессиональна.',
      date: '2025-10-10',
      platform: 'Google',
      status: 'published'
    },
    ...
    },
    {
      ...
      rating: 4,
      comment: 'Хорошее обслуживание, но хотелось бы больше вариантов комплектации.',
      date: '2025-10-08',
      platform: 'Google',
      status: 'published'
    }
  ...
  const pendingRequests = [
    { customer: 'Фарух Рахматов', requestDate: '2025-10-11', status: 'pending' },
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-gray-900 mb-1">Управление отзывами</h2>
        <p className="text-gray-500 text-sm">Сбор и мониторинг отзывов клиентов</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm">
          <div className="flex items-center gap-3 mb-2">
            ...
            <p className="text-gray-500 text-sm">5 звезд</p>
          </div>
          <p className="text-gray-900">{fiveStarReviews} ({Math.round((fiveStarReviews/totalReviews)*100)}%)</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div className="p-5 border-b border-gray-200">
          <h3 className="text-gray-900">Ожидающие отзывы</h3>
        </div>
            ...
            <div key={index} className="p-5 hover:bg-gray-50 transition-colors">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                  ...
                  <p className="text-sm text-gray-500">Запрос отправлен: {request.requestDate}</p>
                </div>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div className="p-5 border-b border-gray-200 flex items-center justify-between">
          <h3 className="text-gray-900">Опубликованные отзывы</h3>
      ...
      <div className="bg-white rounded-xl border border-gray-200 shadow-sm">
        <div className="p-5 border-b border-gray-200">
          <h3 className="text-gray-900">Настройки автоматической рассылки</h3>
        </div>
        <div className="p-5 space-y-4">
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
            <div>
              <p className="text-sm text-gray-900">Запрос отзыва после продажи</p>
              <p className="text-xs text-gray-500 mt-1">Через 3 дня после покупки</p>
            </div>
            <button 
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
            <div>
              <p className="text-sm text-gray-900">Запрос отзыва после сервиса</p>
              <p className="text-xs text-gray-500 mt-1">Сразу после завершения</p>
            </div>
            <button 
          ...
          <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg hover:bg-gray-100 transition-colors">
            <div>
              ...
              <p className="text-xs text-gray-500 mt-1">Если клиент не оставил отзыв</p>
            </div>
            <button 
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-white/90">
              Мы ценим мнение каждого клиента. Ваши отзывы помогают нам становиться лучше и предоставлять 
              превосходный сервис автомобилей BYD.
            </p>
          </div>
        </div>
      </div>
